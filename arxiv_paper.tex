...
\hypersetup{
  ...
  pdfkeywords={Sparse Neural Network},
...
\keywords{Sparse Neural Network, }
...
The Paired Replacement algorithm performs exactly $\max(|\mathcal{A}|, |\mathcal{R}|)$ row writes, achieving the lower bound of \Cref{thm:lower_bound}.
\end{theorem}
